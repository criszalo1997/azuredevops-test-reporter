...
export declare function createTestResultAttachment(azureClient: ITestApi, attachmentRequestModel: TestInterfaces.TestAttachmentRequestModel, azureConfig: IAzureConfig, testRunId: number, testCaseResultId: number): Promise<TestInterfaces.TestAttachmentReference>;
